...
Таким образом, стратегически система должна проектироваться модульно, но бизнес-коммуникация и планирование должны вестись вокруг жизненного цикла документа, так как именно он напрямую отражает клиентский опыт.
